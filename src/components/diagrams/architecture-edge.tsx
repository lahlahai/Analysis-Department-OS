...
export function ArchitectureEdgeLine({ sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, data, markerEnd }: EdgeProps<ArchitectureEdge>) {
  ...
  return <>
    <BaseEdge path={path} markerEnd={markerEnd} style={{ stroke: data?.relationshipType === "event" ? "#b49a63" : "#b8bec8", strokeWidth: 1.5, strokeDasharray: data?.relationshipType === "dependency" ? "5 4" : undefined }} />
